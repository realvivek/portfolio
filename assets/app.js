...
var ARTICLES = [
  {
    ...
    title: 'The retirement display: rebuilding a 34-year patent record, then printing it',
    desc: 'For my father’s retirement: 43 patent postcards, three color-coded ' +
          'decks and an illustrated book, all generated by script from USPTO ' +
          'scans and Crossref, with plain-English summaries for non-technical ' +
          'guests. Includes the citation record (TSMC, Samsung, Disco) and the ' +
          'rebuild of a patent list that was wrong in both directions.',
    url: 'writing/retirement-display.html'
  },
  {
    date: 'JUL 2026',
